...
- **Global scope**: `/home/k1k/studio-code/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/k1k/studio-code/.claude/notes/`)
...
2. Glob `/home/k1k/studio-code/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/k1k/studio-code/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/k1k/studio-code/.claude/notes/` — works in any directory

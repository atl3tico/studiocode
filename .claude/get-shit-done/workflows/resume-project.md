...
<required_reading>
@/home/k1k/studio-code/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/k1k/studio-code/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)

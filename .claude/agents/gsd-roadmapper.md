...
Reference full template: `/home/k1k/studio-code/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/k1k/studio-code/.claude/get-shit-done/templates/state.md`.

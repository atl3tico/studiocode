  ...
  <div class="text-center py-12">
    <div class="max-w-xl">
      ...
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        ...
        >,
        <a href="https://supabase.com" class="underline font-bold hover:opacity-80" target="_blank"
          >Supabase</a
        >,
        <a href="https://stripe.com" class="underline font-bold hover:opacity-80" target="_blank"
          >Stripe</a
        >,
        <a href="https://tailwindcss.com" class="underline font-bold hover:opacity-80" target="_blank"
          >Tailwind</a
        >,
        <a href="https://shadcn-svelte.com" class="underline font-bold hover:opacity-80" target="_blank"
          >shadcn-svelte</a
        >, and
        <a
      ...
      >
        <Button href="https://github.com/CriticalMoments/CMSaasStarter" variant="default" class="px-6">★ us on Github</Button>
        <Button
  ...
  <div class="pt-20 pb-8 px-7">
    ...
    >
      {#each features as feature}
        <Card.Root class="w-[270px] min-h-[300px] flex-none shadow-xl bg-white">
          <Card.Content class="flex flex-col items-center text-center p-6 pt-8">
            <div>
              <svg
                width="50px"
                height="50px"
            ...
            {#if feature.link}
              <div class="pb-4">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  class="rounded-full min-w-[100px]"
...
<div class="flex items-center justify-center min-h-[60vh] mt-12">
    ...
    <div class="max-w-lg">
      ...
      >
        <div class="hidden md:block">
          <a href="https://criticalmoments.io" target="_blank" class="underline hover:opacity-80">
            <div class="rounded-lg border overflow-hidden">
              <div class="flex items-center gap-2 bg-muted px-4 py-2 border-b">
                <div class="rounded-md bg-muted-foreground/10 px-3 py-1 text-sm">https://criticalmoments.io</div>
              </div>
        ...
        <div class="md:hidden">
          <a href="https://criticalmoments.io" target="_blank" class="underline hover:opacity-80">
            <Card.Root class="shadow-xl overflow-hidden">
              <img
                alt="Screenshot of criticalmoments.io homepage"
                class="aspect-2044/1242"
                src="/images/example-home.png"
        ...
        <div class="min-w-[270px] lg:min-w-[420px] flex mt-6 lg:mt-0">
          <div class="my-auto">
            ...
            <div class="mt-4 text-large">
              <Button href="https://criticalmoments.io" variant="default" class="min-w-[200px] mt-3" target="_blank">See it in Action</Button>
            </div>
          </div>
        </div>
      </div>

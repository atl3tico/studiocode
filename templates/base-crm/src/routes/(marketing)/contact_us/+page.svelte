  ...
  >
    {#if showSuccess}
      <div class="flex flex-col place-content-center lg:min-h-[70vh]">
        <Card class="py-6 px-6 mx-2 lg:mx-0 lg:p-6 mb-10 shadow-lg">
          <CardContent>
    ...
    {:else}
      <Card class="p-4 pt-6 mx-2 lg:mx-0 lg:p-6 shadow-lg">
        <CardContent>
          <form
                ...
                {#if field.inputType === "textarea"}
                  <textarea
                    ...
                    class="{errors[field.id]
                      ? 'border-destructive'
                      : ''} h-24 mt-1 rounded-md border border-input bg-background px-3 py-2 text-sm w-full mb-3"
                  ></textarea>
                {:else}
                  <Input
                    id={field.id}
                    ...
                    class="{errors[field.id]
                      ? 'border-destructive'
                      : ''} mt-1 w-full mb-3 text-base py-4"
                  />
                {/if}
              </label>
            {/each}
